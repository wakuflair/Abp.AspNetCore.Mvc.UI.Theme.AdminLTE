...
namespace Abp.AspNetCore.Mvc.UI.Theme.AdminLTE
{
    ...
    public class AdminLTEModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            PreConfigure<IMvcBuilder>(mvcBuilder =>
            {
                mvcBuilder.AddApplicationPartIfNotExists(typeof(AdminLTEModule).Assembly);
            });
        }
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.FileSets.AddEmbedded<AdminLTEModule>("Abp.AspNetCore.Mvc.UI.Theme.AdminLTE");
            });
