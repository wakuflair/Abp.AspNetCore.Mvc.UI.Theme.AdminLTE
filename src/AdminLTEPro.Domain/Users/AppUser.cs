...
namespace AdminLTEPro.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AdminLTEProDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AdminLTEProEfCoreEntityExtensionMappings to extend the IdentityUser entity
